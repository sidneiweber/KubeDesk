...
function parseSyslogTimestamp(timestamp: string): string {
...
function parseNginxTimestamp(timestamp: string): string {
...
function parseLogLine(line: string, podName: string, index: number): Log {
...
function parseLogs(logContent: string, podName: string): Log[] {
